...
public class car implements vehicle{
    ...
    public int getCurrent_gear(){
        System.out.print("Enter the Current Gear of Car: ");
        Current_gear =sc.nextInt();
        return Current_gear;
    }

    public int getCurrent_Speed(){
        System.out.print("Enter the Current Speed of Car(km/h): ");
    ...
    public void printState(){
        System.out.println("Gear Of Car is: "+Current_gear+"\nSpeed Of Car is(km/h): "+Current_Speed+"\n");
    }
